...
ImageView::on_key_down(int key)
{
	...
	else if(key == 'N')
	{
        ...
        PRINT_LOG(0, "Total number of planes: " << sortedPlaneParameters.size() << ".\n");
        PRINT_LOG(0, print2dVector(sortedPlaneParameters, "Plane Parameters:\n", ""));
		PRINT_LOG(0, print2dVector(boundingBoxPoints, "Bounding Box points:\n", ""));
